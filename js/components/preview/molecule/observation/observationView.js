  ...
  ({
    ...
    useEffect(() => {
      if (!proteinData) {
        ...
        const result = proteinData && (proteinData.diff_info || proteinData.event_info || proteinData.sigmaa_info);
        setHasMap(result);
      }
...
ObservationView.displayName = 'ObservationView';
