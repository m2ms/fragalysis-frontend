...
export const constants = {
  ...
  SET_ASSOCIATED_DOWNLOAD_TAG_NAME: prefix + 'SET_ASSOCIATED_DOWNLOAD_TAG_NAME',
  ...
  RESET_SELECTION_STATE_ON_SNAPSHOT_CHANGE: prefix + 'RESET_SELECTION_STATE_ON_SNAPSHOT_CHANGE'
};
