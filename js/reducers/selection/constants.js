...
export const constants = {
  ...
  SET_ARTEFACTS_CHAIN_LIST: prefix + 'SET_ARTEFACTS_CHAIN_LIST',
  APPEND_ARTEFACTS_CHAIN_LIST: prefix + 'APPEND_ARTEFACTS_CHAIN_LIST',
  REMOVE_FROM_ARTEFACTS_CHAIN_LIST: prefix + 'REMOVE_FROM_ARTEFACTS_CHAIN_LIST',
  ...
  UPDATE_MOL_IN_LHS_OBSERVATIONS: prefix + 'UPDATE_MOL_IN_LHS_OBSERVATIONS',
  ...
  SET_SHOW_DISPLAYED_MOLECULES: prefix + 'SET_SHOW_DISPLAYED_MOLECULES',
  ...
  SET_LHS_IS_FULLY_RENDERED: prefix + 'SET_LHS_IS_FULLY_RENDERED',

  SET_UNIFIED_FILTER_ITEM: prefix + 'SET_UNIFIED_FILTER_ITEM',

  SET_IS_COORDINATE_FILTER_APPLIED: prefix + 'SET_IS_COORDINATE_FILTER_APPLIED',
  SET_COORDINATE_FILTER_RESULTS: prefix + 'SET_COORDINATE_FILTER_RESULTS',
  SET_SPHERE_COORDINATE: prefix + 'SET_SPHERE_COORDINATE',
  SET_COORDINATE_RADIUS: prefix + 'SET_COORDINATE_RADIUS',
  SET_SPHERE_RENDERED: prefix + 'SET_SPHERE_RENDERED'
};
