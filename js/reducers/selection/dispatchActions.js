import {
  resetCurrentVectorCompoundSettingsWithoutSelection,
  setCurrentVectorCompounds
...
export const selectVectorAndResetCompounds = vectorSmile => async (dispatch, getState) => {
  ...
  await dispatch(resetCurrentVectorCompoundSettingsWithoutSelection(false));
  const currentCompoundsList = getAllCompoundsList(getState());
  dispatch(setCurrentVectorCompounds(currentCompoundsList));
};
